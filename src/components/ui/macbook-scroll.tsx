...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center py-0 md:py-48 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
      ...
      >
        <div className="dark:text-light text-7xl font-bold text-dark">
            {title}
        </div>
        <div className="text-orange-500 text-7xl font-bold">
        {subtitle}
        </div>
        <div className="w-[44rem] text-base">
         {content}
        </div>
      </motion.h2>
      {/* Lid */}
      ...
      />
      {/* Base area */}
      <div className="h-[22rem] w-[32rem] bg-slate-200 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
        ...
        {showGradient && (
          <div className="h-40 w-full absolute bottom-0 inset-x-0 bg-gradient-to-t dark:from-dark from-light via-light dark:via-dark to-transparent z-50"></div>
        )}
  ...
  return (
    <div className="h-full rounded-md bg-[#050505] mx-1 p-1">
      ...
      <Row>
        ...
        <KBtn>
          <div className="h-4 w-4 rounded-full  bg-gradient-to-b from-20% from-neutral-900 via-dark via-50% to-neutral-900 to-95% p-px">
            <div className="bg-dark h-full w-full rounded-full" />
          </div>
        </KBtn>
      </Row>
...
export const KBtn = ({
  ...
  return (
    <div
      className={cn(
        "p-[0.5px] rounded-[4px]",
        backlit && "bg-light/[0.2] shadow-xl shadow-light"
      )}
    >
      <div
        className={cn(
